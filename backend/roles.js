...
- Анализ безопасности сайтов на базе SiteXML;
- Анализ модульной системы SiteXML; `,
        'awards':'',
        'demands':'Встрече 1 раз в неделю',
        'interests':['Оптимальное управление', 'Динамическе сисетмы', 'Теория автоматического управления', 'Оптимизация программных движений'],
...

    {
        ...
        'awards': '1500 руб.',
        'demands':'Доступность в декабре 2021 года',
        'interests':['Оптимальное управление', 'Динамическе сисетмы', 'Теория автоматического управления', 'Оптимизация программных движений'],
        'skills':['MatLab']
    },
